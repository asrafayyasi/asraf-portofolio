...
export const contents = {
    ...
    projects: [
      {
        ...
        type: 'Deep Learning',
        embed: 'https://www.canva.com/design/DAGerHm8eRs/IWuM7fsHu6SNUDI-js5BVg/edit?embed_content=DAGerHm8eRs&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton',
      },
      {
        title: 'Vehicle Object Detection and Traffic Accident Classification Using Convolutional Neural Network',
        desc: 'Development of a vehicle object detection model using YOLOv9 combined with the SMA Algorithm and ByteTrack to detect anomalies and classify road events as accidents or non-accidents.',
  ...
  id: {
    ...
    skillsSection: {
      ...
      subtitle: 'Tools inti, soft skill, dan pelatihan yang mendukung pekerjaan saya sehari-hari.',
      hard: [
        'SQL',
        'Python (Pandas, NumPy)',
        'Power BI',
