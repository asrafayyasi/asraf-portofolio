...
export const contents = {
  en: {
    ...
    labels: {
      ...
      projectsSubtitle: 'A collection of data projects that highlight my thinking process, analysis, and impact.',
      open: 'Open ↗',
      ...
      contactSubtitle: 'Open to collaboration, projects, or a short discussion.',
      availableForCollab: 'Available for collaboration',
      connectTitle: "Let's Connect",
      connectSubtitle: "Choose the channel you're most comfortable with. (Email for formal matters)",
    ...
    about: {
      ...
      skills: ['Algorithms and Programming', 'Database', 'Data Analysis and Visualization', 'Machine Learning', 'Computer Vision', 'Business Data Analysis', 'Data Mining', 'Statistics'],
      kicker: 'ABOUT ME',
      ...
      timeline: [
        {
          ...
          thesis: 'Vehicle Object Detection and Accident Classification Using Convolutional Neural Networks',
          year: '2021 - 2025',
        },
        {
          title: 'Experience',
    ...
    projects: [
      {
        ...
        tech: ['Python', 'TensorFlow', 'CNN', 'YOLOv9', 'MobileNetv2', 'SMA Algorithm', 'Object Tracking', 'ByteTrack'],
        thumb: '/projectdl.jpg',
      ...
      {
        title: 'E-Commerce Sales Performance Analytics with BigQuery',
        desc: 'This project is an end-to-end data analytics portfolio project that analyzes e-commerce sales performance using Google BigQuery and Looker Studio. Raw transactional data from Kaggle is loaded into BigQuery and structured into multiple data warehouse layers, including raw, staging, and mart. SQL transformations are used to clean the data, create analytical tables, and build a dashboard-ready view. The final Looker Studio dashboard provides insights into total revenue, order volume, average order value, product category performance, customer location, payment behavior, and delivery performance. This project demonstrates skills in SQL transformation, cloud data warehousing, data modeling, KPI analysis, dashboard development, and business insight generation.',
        tech: ['Google BigQuery', 'SQL', 'Looker Studio', 'Kaggle Dataset', 'GitHub'],
        thumb: '/project-bigquery-ecommerce.png',
        link: 'https://www.canva.com/design/DAHOMxGQ5x4/5onYWzubYFRCEhMN0Oc8jg/view',
        embed: 'https://www.canva.com/design/DAHOMxGQ5x4/5onYWzubYFRCEhMN0Oc8jg/view?embed',
        type: 'Data Analytics',
        year: '2026',
      },
      {
    ...
    skillsSection: {
      ...
      subtitle: 'Core tools, soft skills, and training that support my day-to-day work.',
      hard: [
        ...
        { name: 'Power BI', icon: '/icons/skills/powerbi.png' },
        { name: 'Tableau', icon: '/icons/skills/tableau.png' },
        { name: 'Looker Studio', icon: '/icons/skills/looker.png' },
        { name: 'dbt', icon: '/icons/skills/dbt.png' },
        { name: 'Google Big Query', icon: '/icons/skills/bigquery.png' },
        { name: 'Github', icon: '/icons/skills/github.png' },
        { name: 'Bitbucket', icon: '/icons/skills/bitbucket.png' },
        { name: 'AWX', icon: '/icons/skills/awx.png' },
        { name: 'Machine Learning', icon: '/icons/skills/machine learning.png' },
        { name: 'Meta Ads', icon: '/icons/skills/meta.png' },
      ],
      soft: ['Analytical Thinking', 'Problem Solving', 'Communication', 'Time Management', 'Attention to Detail', 'Teamwork'],
      trainings: [
    ...
    orgSection: {
      ...
      subtitle: 'My leadership roles and contributions in organizations and activities.',
      items: [
        {
        ...
        },
        {
          ...
          period: '2021-2025',
          image: '/ukm.jpeg',
          bullets: ['1st Place, SuperSoccer Futsal Championship Regional Surabaya', '4th Place, SuperSoccer Futsal Championship National', 'Participated in the UGMFC Football Tournament'],
        },
        {
        ...
        },
        {
          ...
          period: '2022',
          image: '/himsi.jpeg',
          bullets: ['Participated in planning and executing more than 5 sports and arts programs.', 'Prepared evaluation reports for sports activities.', 'Handled the selection and development process of delegates for the Dean Cup.'],
        },
        {
        ...
        },
        {
          ...
          period: '2022',
          image: '/decup1.jpeg',
          bullets: ['Coordinated with the Futsal Coordinator to support the smooth execution of the event.', 'Prepared match schedules and competition systems with the coordinator and other staff members.'],
        },
      ],
    },
    ...
    certSection: {
      kicker: 'CREDENTIALS',
      title: 'Certificates',
      subtitle: 'Selected certificates that support my competencies and experience.',
      featured: [
        {
    ...
    workSection: {
      ...
      subtitle: 'A summary of my roles, responsibilities, and the impact I delivered.',
      items: [
        {
          role: 'Data Analyst',
        ...
        },
        {
          ...
          bullets: ['Served 30 customers per day.', 'Operated printers and photocopy machines.', 'Handled office administration.'],
          tools: ['Excel', 'Word'],
        },
      ],
    },
  ...
  id: {
    ...
    labels: {
      ...
      projectsSubtitle: 'Kumpulan proyek data yang menonjolkan proses berpikir, analisis, dan impact.',
      open: 'Buka ↗',
      ...
      contactTitle: 'Kontak',
      contactSubtitle: 'Terbuka untuk kolaborasi, project, atau diskusi singkat.',
      availableForCollab: 'Tersedia untuk kolaborasi',
      connectTitle: 'Mari Terhubung',
      connectSubtitle: 'Pilih channel yang paling nyaman. (Email untuk urusan formal)',
    ...
    projects: [
      ...
      {
        title: 'Analisis Performa Penjualan E-Commerce dengan BigQuery',
        desc: 'Project ini merupakan portofolio data analytics end-to-end yang menganalisis performa penjualan e-commerce menggunakan Google BigQuery dan Looker Studio. Data transaksi mentah dari Kaggle dimuat ke BigQuery dan disusun ke dalam beberapa layer data warehouse, yaitu raw, staging, dan mart. Transformasi SQL digunakan untuk membersihkan data, membuat tabel analitik, serta membangun view yang siap digunakan untuk dashboard. Dashboard akhir di Looker Studio menampilkan insight mengenai total revenue, jumlah order, average order value, performa kategori produk, lokasi customer, perilaku pembayaran, dan performa pengiriman. Project ini menunjukkan kemampuan dalam SQL transformation, cloud data warehousing, data modeling, analisis KPI, pembuatan dashboard, dan penyusunan insight bisnis.',
        tech: ['Google BigQuery', 'SQL', 'Looker Studio', 'Kaggle Dataset', 'GitHub'],
        thumb: '/project-bigquery-ecommerce.png',
        link: 'https://www.canva.com/design/DAHOMxGQ5x4/5onYWzubYFRCEhMN0Oc8jg/view',
        embed: 'https://www.canva.com/design/DAHOMxGQ5x4/5onYWzubYFRCEhMN0Oc8jg/view?embed',
